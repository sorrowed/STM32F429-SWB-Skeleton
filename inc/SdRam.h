...
void  SdRamWrite(uint32_t* pBuffer, uint32_t uwWriteAddress, uint32_t uwBufferSize);
void  SdRamRead(uint32_t* pBuffer, uint32_t uwReadAddress, uint32_t uwBufferSize);
